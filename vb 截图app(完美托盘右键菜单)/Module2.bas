Attribute VB_Name = "SavePicutre"
Option Explicit

'Global ABC as Long  '全局变量，整个过程可用
...
If dfaddress = 1 Then
    ...
    Form2.Hide
                     ...
                     If dfaddress = 0 Then
                     Shell "explorer " & Form2.CommonDialog1.FileName, 1 'shell函数，打开C盘  Shell "explorer 路径"
                     Else
                     Shell "explorer " & Form2.Text1.Text & Form1.Text4.Text & Form1.Combo1.Text, 1
                     End If
...
End If
Debug.Print "In dl(): clip:" & CStr(clip) & " dfaddress: "; CStr(dfaddress)


Errlog:
   Call whenErr(Err.number, "shot", "dl()")
   If Err.number = 521 Then Resume
End Sub
